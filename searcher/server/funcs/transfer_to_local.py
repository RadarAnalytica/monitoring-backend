...
async def recount_oracle():
    ...
    stmt = """SELECT
        ...
        round(if(qh.total_products > 0, rg.sum_30 / qh.total_products, 0), 3) AS freq_per_good,
            ...
            for row in q.result_rows:
                ...
                if supplier_revenue and len(supplier_revenue) > 0:
                    ...
                    suppliers_with_sales_percent = round(
                        (len(supplier_revenue) - zero_sales_suppliers) * 100 / len(supplier_revenue))
                    ...
                    monopoly_percent = 0
                rating, competition_level = evaluate_niche(demand_coef=freq_per_good, monopoly_pct=monopoly_percent,
                                                           advert_pct=advert_percent, buyout_pct=buyout_percent,
